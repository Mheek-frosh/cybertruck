            ...
            <AnimatePresence>
                {isDashboardOpen && (
                    <motion.div
                        ...
                        className="fixed left-24 top-1/2 -translate-y-1/2 w-[900px] z-[60] pointer-events-auto"
                    >
            ...
            <AnimatePresence>
                {isAssistantOpen && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, x: 0 }}
                        exit={{ opacity: 0, x: 50, transition: { duration: 0.3 } }}
                        className="fixed right-12 top-1/2 -translate-y-1/2 w-[420px] z-[60] flex flex-col gap-6 pointer-events-auto"
                    >
